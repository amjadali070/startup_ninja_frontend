    ...
    () => [
      {
        title: "AI Chat",
        description:
          "Collaborate with a smart AI assistant trained on startup best practices and industry insights.",
      ...
      },
      {
        ...
        description:
          "Create stunning on-brand visuals, hero sections, and marketing materials with simple prompts.",
      ...
      },
      {
        ...
        description:
          "Build professional landing pages and websites without writing a single line of code.",
      ...
      },
      {
        title: "Social Pro",
        description:
          "Automate your social media presence with AI-generated content and strategic posting.",
        ...
        <div className="max-w-7xl mx-auto space-y-8">
          <section className="text-center space-y-4 mb-8">
            ...
            <p className="text-lg text-white/70 max-w-2xl mx-auto">
              Explore our collection of AI-powered tools designed to accelerate
