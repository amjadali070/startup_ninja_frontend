...
const HomePage: React.FC = () => {
  ...
  return (
    <FrontLayout>
      ...
      <section
        ref={bannerRef}
        className={`relative w-full min-h-[700px] flex items-center justify-center bg-gradient-to-b from-[#2a0a0a] via-[#1a0a0a] to-[#0a0a0a] overflow-hidden transition-all duration-700 ${showBanner ? 'animate-slideUpFull' : 'translate-y-[100vh]'
          }`}
      >
        {/* Glow Background */}
        ...
        {/* Content */}
        <div className="relative z-10 w-full max-w-5xl mx-auto flex flex-col items-center py-16">
          <h3 className="text-xs md:text-sm text-white/80 text-center mb-2 tracking-widest">
            EXPLORE THE POWER OF AI TECHNOLOGY
          </h3>
          <h2 className="text-3xl md:text-5xl font-bold text-center mb-4 text-white drop-shadow-lg leading-[4rem]">
          ...
          <div className="relative w-full flex items-center justify-center">
            ...
            {chatBubbles.map((bubble, idx) => (
              <span
                key={idx}
                className={`absolute ${bubble.style} bg-[#ac898938] text-white text-sm px-5 py-3 rounded-2xl shadow-[0_4px_24px_0_rgba(255,59,59,0.25)] border border-white/10 backdrop-blur-md`}
      ...
      <section className="relative w-full min-h-[700px] bg-black overflow-hidden mt-10 mb-10">
        ...
        <section className="relative w-full flex flex-col md:flex-row gap-8 items-center justify-center py-10 px-4 mt-10 overflow-hidden">
          <div className="z-10 rounded-3xl p-8 max-w-xl w-full text-left">
          ...
          <div className="relative flex-1 flex items-center justify-center min-w-[340px] max-w-lg w-full z-10">
            <div className="relative drop-shadow-[30px_20px_100px_rgba(237,53,28,0.3)]">
              <img src="/images/mockup-banner.png" alt="App Mockup" className="w-[442px] h-[795px] object-contain" />
        ...
        <section className="relative w-full flex flex-col md:flex-row gap-8 items-center justify-center py-10 px-4 mt-10 overflow-hidden bg-[#0f0503]">
          <img src="/images/banner-info.gif" alt="Banner Mockup" className="object-cover" />
        </section>
      </section>
      <PricingSection />
      <LatestNewsSection />
