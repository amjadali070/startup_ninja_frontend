                ...
                children: [
                    {
                        ...
                        children: [
                            ...
                            {
                                type: 'row',
                                style: { gap: '8px', alignItems: 'center', justifyContent: 'center', flex: 1 },
                                children: [
                                    {
                                        type: 'button',
                                        className: `device-btn device-desktop ${currentDevice === 'desktop' ? 'active' : ''}`,
                                    ...
                                    {
                                        type: 'button',
                                        className: `device-btn device-tablet ${currentDevice === 'tablet' ? 'active' : ''}`,
                                        icon: `<svg width="18" height="18" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    ...
                                    {
                                        type: 'button',
                                        className: `device-btn device-mobile ${currentDevice === 'mobile' ? 'active' : ''}`,
                                        icon: `<svg width="18" height="18" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                            ...
                                            children: [
                                                {
                                                    ...
                                                    onClick: ({ editor }) => {
                                                        editor.runCommand('studio:layoutToggle', {
                                                            id: 'blocks-panel',
                                                            header: false,
                                                            placer: { type: 'absolute', position: 'left', title: 'Add Blocks', size: 'l' },
                                                            layout: {
                                                                type: 'column',
                                                ...
                                                // Layers Button
                                                {
                                                    ...
                                                    onClick: ({ editor }) => {
                                                        editor.runCommand('studio:layoutToggle', {
                                                            id: 'layers-panel',
                                                            header: false,
                                                            placer: { type: 'absolute', position: 'left', title: 'Layers', size: 'l' },
                                                            layout: {
                                                                type: 'column',
                                                                style: { gap: 20, padding: 10, overflow: 'auto' },
                                                                children: [
                                                ...
                                                // Global Styles Button
                                                {
                                                    ...
                                                    onClick: ({ editor }) => {
                                                        editor.runCommand('studio:layoutToggle', {
                                                            ...
                                                            header: false,
                                                            placer: { type: 'absolute', position: 'left', title: 'Global Styles', size: 'l' },
                                                            layout: {
                                                                type: 'column',
                                                                style: { gap: 20, padding: 10, overflow: 'auto' },
                                                                children: [
                                                ...
                                                // Settings Button (Global Global Settings)
                                                {
                                                    ...
                                                    onClick: ({ editor }) => {
                                                        editor.runCommand('studio:layoutToggle', {
                                                            ...
                                                            header: false,
                                                            placer: { type: 'absolute', position: 'left', title: 'Global Settings', size: 'l' },
                                                            layout: {
                                                                type: 'column',
                                                                style: { gap: 20, padding: 10, overflow: 'auto' },
                                                                children: [
                    ...
                    globalStyles: {
                        default: [
                            ...
                            // ==================== Subheading Section ====================
                            {
                                ...
                                label: 'Color',
                                defaultValue: '#601843',
                                category: { id: 'subheading', label: 'Subheading', open: false }
                            },
                            {
