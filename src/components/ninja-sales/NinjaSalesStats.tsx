...
const NinjaSalesStats: FC = () => {
  ...
  return (
    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
      {stats.map((stat, i) => (
        <div key={i} className="group relative bg-[#121212] border border-white/[0.03] rounded-[32px] p-8 hover:bg-[#161616] transition-all hover:border-[#EF444420] shadow-xl overflow-hidden">
          ...
          <div className="relative z-10 space-y-6">
            ...
            <div>
              <h3 className="text-4xl font-black text-white tracking-tight mb-3 group-hover:scale-105 transition-transform origin-left">{stat.value}</h3>
