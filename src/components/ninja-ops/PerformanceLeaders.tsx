  ...
  return (
    <div className="bg-[#121212] border border-white/[0.03] rounded-[32px] p-8 h-full font-plus-jakarta flex flex-col gap-6 group overflow-hidden relative">
      <div className="flex items-center justify-between mb-2">
        <h2 className="text-xl font-black text-white tracking-tight uppercase">Performance Leaders</h2>
        <div className="px-2 py-0.5 bg-[#EF444415] border border-[#EF444425] rounded-full">
          <span className="text-[8px] font-black text-[#EF4444] uppercase tracking-widest leading-loose">Q1 Top Percentile</span>
        </div>
      </div>
