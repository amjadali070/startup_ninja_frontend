...
interface NinjaOpsHeaderProps {
  onNewInitiative: () => void;
  onExport?: () => void;
}

const NinjaOpsHeader: FC<NinjaOpsHeaderProps> = ({ onNewInitiative, onExport }) => {
  return (
    <div className="mb-6">
        ...
        <div className="relative z-10 flex h-full flex-col justify-between gap-3 px-3 py-4 sm:flex-row sm:items-center sm:gap-4 sm:px-4 sm:py-5 md:px-6 md:py-6 xl:px-8 xl:py-8">
          <div className="flex-1 min-w-0">
            ...
            <p className="font-plus-jakarta mt-1 text-xs leading-5 text-gray-300 sm:mt-2 sm:text-sm sm:leading-6 md:text-[16px] md:leading-[24px]">
              The Workforce Manager — Team Performance & Execution Intelligence
            </p>
          </div>
          <div className="flex-shrink-0 flex items-center gap-3">
            ...
            <button
              ...
              className="font-plus-jakarta inline-flex items-center justify-center gap-1.5 rounded-lg bg-gradient-to-r from-[#DC2626] to-[#B91C1C] px-3 py-2 text-xs font-medium text-white transition-all duration-200 hover:shadow-lg sm:px-4 sm:py-2.5 sm:text-sm shadow-2xl shadow-[#EF444420]"
            >
