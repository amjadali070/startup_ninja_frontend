...
interface GeminiProviderCardProps {
  id: string;
  name: "Google Gemini";
  icon: IconType;
  totalBalance: number;
...
const GeminiProviderCard: React.FC<GeminiProviderCardProps> = ({
  id,
  name,
  icon: Icon,
  totalBalance,
      ...
      {loading && (
        <div className="absolute inset-0 z-50 flex items-center justify-center bg-black/60 backdrop-blur-[1px] transition-all duration-300">
           <div className="flex flex-col items-center gap-2">
             ...
             <span className="text-xs font-medium text-blue-400 animate-pulse">Updating...</span>
           </div>
        </div>
      )}
      ...
      <div className="p-4 sm:p-6">
        ...
        <div className="flex flex-col sm:flex-row sm:items-start justify-between mb-6 sm:mb-8 gap-4 sm:gap-0">
          <div className="flex items-center gap-4">
            <div className={`flex h-12 w-12 sm:h-14 sm:w-14 items-center justify-center rounded-xl bg-gradient-to-br ${color} shadow-lg shadow-blue-900/20 shrink-0`}>
        ...
        <div className="mb-6 bg-[#242424]/30 rounded-lg p-3 border border-[#2a2a2a]">
           <div className="flex items-center gap-2 mb-2">
              <FiCalendar className="text-blue-500 h-3.5 w-3.5" />
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 mb-6">
          <button
            ...
            className="flex items-center justify-center gap-2 px-4 py-2.5 rounded-lg bg-blue-600/10 border border-blue-600/20 text-blue-400 hover:bg-blue-600/20 hover:border-blue-600/40 transition-all duration-200 text-sm font-semibold group/btn"
          >
        ...
        {/* Detailed Stats Grid */}
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 mb-6">
          <div className="rounded-xl bg-[#0D0D0D] p-3.5 border border-[#242424] hover:border-blue-900/30 transition-colors">
            <div className="flex items-center gap-2 mb-2">
        ...
        <div className="rounded-xl bg-[#0D0D0D] p-4 border border-[#242424] relative overflow-hidden">
           {/* Subtle glow effect */}
           <div className="absolute -top-10 -right-10 w-24 h-24 bg-blue-500/5 blur-2xl rounded-full pointer-events-none"></div>
           ...
           <div className="grid grid-cols-3 gap-4 divide-x divide-[#242424]">
             ...
             <div className="text-center pl-2">
               ...
               <div className="text-sm font-bold text-blue-400 flex items-center justify-center gap-0.5">
...
export default GeminiProviderCard;
