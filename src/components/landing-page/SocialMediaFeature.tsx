...
const SocialMediaFeature: React.FC = () => (
    <section className="w-full flex flex-col md:flex-row gap-8 items-center justify-center py-10 px-4 feature-bg">
        <div className="rounded-3xl shadow-xl p-6 md:p-8 max-w-xl w-full text-left">
            <h2 className="text-2xl md:text-4xl font-bold text-white mb-2">Social Media Pro</h2>
            <h3 className="text-xl md:text-3xl font-bold text-[#ED351C] mb-6">Your Digital Head</h3>
        ...
        <div className="relative flex-1 flex flex-col items-center justify-center min-w-[300px] md:min-w-[340px] max-w-lg w-full mt-12 md:mt-0 md:ml-10 group/chat">
            <img src="/images/socialchat-banner.png" alt="Social Chat Feature" className="w-full h-auto" />
        </div>
    </section>
);
