...
const TokenUsageCard: FC<TokenUsageCardProps> = ({ used, limit, resetInHours }) => {
  ...
  return (
  <div className="flex h-full w-full flex-col rounded-lg border border-[#242424] bg-gradient-to-br from-[#1A1A1A] to-[#0D0D0D] px-4 pb-6 pt-5 text-center shadow-[0px_8px_24px_rgba(0,0,0,0.4)] sm:px-6 sm:pb-8 sm:pt-7">
